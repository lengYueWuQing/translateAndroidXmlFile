...
public class TranslateUtils {
	...
	private static final String USER_AGENT = "Mozilla/5.0";// "Mozilla/5.0
															// (Macintosh; Intel
															// Mac OS X 10_12_6)
															// AppleWebKit/537.36
															// (KHTML, like
	...
	private static TranslateUtils _instance = null;
	...
	public String translateText(String text, String sourceLang, String targetLang) throws Exception {
		...
		// +"?client="+CLIENT+"&sl="+sourceLang+"&tl="+targetLang+"&dt=t&q="+
		// text ;
